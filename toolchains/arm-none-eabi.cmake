if(NOT _VCPKG_ARM_NONE_EABI_TOOLCHAIN)
    set(_VCPKG_ARM_NONE_EABI_TOOLCHAIN 1)
    ...
    if(VCPKG_TARGET_ARCHITECTURE STREQUAL "arm-none-eabi")
        set(CMAKE_SYSTEM_PROCESSOR arm-none-eabi CACHE STRING "")
    endif()
    ...
    find_program(CMAKE_C_COMPILER "${CMAKE_SYSTEM_PROCESSOR}-gcc")
    find_program(CMAKE_CXX_COMPILER "${CMAKE_SYSTEM_PROCESSOR}-g++")
